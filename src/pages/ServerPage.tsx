...
//             <span class="font-regular block p-2 text-lg">ID - b95a843v93</span>
//             <span class="font-regular block p-2 text-lg">CPU % - 1.32%</span>
//             <span class="font-regular block p-2 text-lg">
//               Mem used / limit - 8.279MiB / 1.952GiB
//             </span>
//             <span class="font-regular block p-2 text-lg">Memory % - 0.32%</span>
//             <span class="font-regular block p-2 text-lg">
//               Net I/O - 916B / 0B
//             </span>
//             <span class="font-regular block p-2 text-lg">
//               Block I/O - 147kB / 0B
//             </span>
//             <span class="font-regular block p-2 text-lg">PIDs - 9</span>
//           </span>
//         </div>
//       </div>
