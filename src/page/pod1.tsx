export const Pod1page = () => {
    return (
        <div className = "bg-[#EEF0F8]">
            <h1 className="w-[32.33vw] h-[6.22vh] pt-[4.37vh] pl-[4.89vw] font-Inter text-5xl font-semibold"> AOB Dashboard </h1>

            <h2 className="pt-[9.75vh] pl-[4.89vw] flex flex-row items-center font-Inter text-4xl font-semibold">
                <svg className="h-9 w-9 justify-start" xmlns="http://www.w3.org/2000/svg" fill="none">
                    <path stroke="#476CFF" stroke-linecap="round" stroke-linejoin="round" stroke-width="5" d="M25.625 8.75 14.375 20l11.25 11.25"/>
                </svg>
                <div className="ml-4">Pod 1 - Pod ID</div>
            </h2>

            <h3 className="w-[15.38vw] h-[4.89vh] pt-[6.00vh] pl-[4.89vw] font-Inter text-4xl font-semibold"> All Pods </h3>
