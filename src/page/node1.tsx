    ...
    return (
        <div className = "bg-[#EEF0F8]">
            ...
            <h2 className="pt-[9.75vh] pl-[4.89vw] flex flex-row items-center font-Inter text-4xl font-semibold">
                ...
                <div className="ml-4">Node 1 - Node ID</div>
            </h2>

            <h3 className="w-[15.38vw] h-[4.89vh] pt-[6.00vh] pl-[4.89vw] font-Inter text-4xl font-semibold"> All Jods </h3>

            <div className="px-10 p-20 grid gap-5 lg:grid-cols-1 justify-around">
                ...
                <div className="card flex flex-row items-center">
                    ...
                    <span className="p-5 font-Inter">
                        ...
                        <span className="p-4 text-lg font-regular">ID - E9EIKCJGK</span>
